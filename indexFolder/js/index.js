...
addEventListener('scroll', () => {
  sticky.offsetTop > 100 ? fadeOut1.style.opacity = 0 : fadeOut1.style.opacity = 1;
  sticky.offsetTop > 1000 ? fadeOut2.style.opacity = 0 : fadeOut2.style.opacity = 1;
  sticky.offsetTop > 1700 ? fadeOut3.style.opacity = 0 : fadeOut3.style.opacity = 1;
  sticky.offsetTop > 2580 ? fadeOut4.style.opacity = 0 : fadeOut4.style.opacity = 1;
  sticky.offsetTop > 3000 ? fadeOut5.style.opacity = 0 : fadeOut5.style.opacity = 1;
})
